 ...
 * @n: pointer to the max number of bytes to compare
 *
...
/**
 * _close - this close a file descriptor and print an error message
 * upon failure
...
/**
 * _read - this reads from a file and print error message upon failure
 * @fd: pointer to the file descriptor to read from
 * @buf: pointer to the buffer to write to
 * @count: pointer to the number of bytes to read
 */
...
/**
 * elf_magic - this prints ELF magic
...
/**
 * elf_class - this prints ELF class
 * @buffer: pointer to the ELF header
 * Return: pointer to the bit mode (32 or 64)
 */
...
/**
 * elf_version - this prints ELF version
 * @buffer: pointer to the ELF header
 */
...
/**
 * elf_osabi - this prints ELF OS/ABI
 * @buffer: pointer to the ELF header
 */
...
/**
 * elf_abivers - this prints ELF ABI version
 * @buffer: pointer to the ELF header
 */
...
/**
 * elf_type - this prints ELF type
 * @buffer: pointer to the ELF header
 * @big_endian: pointer to the endianness (big endian if non-zero)
 */
...
/**
 * elf_entry - this prints entry point address
 * @buffer: pointer to the string containing an entry point address
 * @bit_mode: pointer to the bit mode (32 or 64)
 * @big_endian: pointer to the endianness (big endian if non-zero)
 */
...
/**
 * main - this copys a file's contents to another file
